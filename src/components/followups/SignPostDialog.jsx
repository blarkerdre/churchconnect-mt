...
import { Loader2, Users, Home, Sparkles } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          {type === "unit_leader" && (
            <>
              ...
              {unitName && (
                <div className="space-y-1.5">
                  <Label className="text-xs">Leader to assign</Label>
                  {unitLeaders.length === 0 ? (
                    <p className="text-xs text-muted-foreground">No leaders assigned to this unit yet.</p>
                  ) : (
