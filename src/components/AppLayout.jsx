...
const allNavItems = [
  ...
  { name: "Church Unit", icon: ClipboardList, path: "/church-unit", access: "unit" },
  ...
  { name: "Preteens Attendance", icon: Users, path: "/preteens-attendance", access: "children_church" },
...
export default function Layout({ children }) {
  ...
  return (
    ...
    <div className="min-h-screen bg-background flex">
      ...
      {/* Main content */}
      <div className="flex-1 flex flex-col min-h-screen min-w-0 w-full lg:w-auto">
