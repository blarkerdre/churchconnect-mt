// ISO-3166 countries with their nationality (demonym).
// The stored value is the demonym string, e.g. "British", "Nigerian".
export const COUNTRIES = [
  ...
  { country: "Cape Verde", nationality: "Cabo Verdean" },
  ...
  { country: "Congo (Brazzaville)", nationality: "Congolese" },
  { country: "Congo (DRC)", nationality: "Congolese (DRC)" },
  ...
  { country: "Dominica", nationality: "Dominican (Dominica)" },
  ...
  { country: "Türkiye", nationality: "Turkish" },
...
export const NATIONALITIES = COUNTRIES.map((c) => c.nationality);
