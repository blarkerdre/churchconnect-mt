...
const BibleSchoolStudentNumberEmail = ({ firstName, courseName, tenantName, courses }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your Bible School application has been approved</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          <strong>{courseName || 'Bible School'}</strong> at{' '}
          {tenantName || SITE_NAME} has been approved.
        </Text>
        ...
        <Text style={text}>
          Your exam link will be sent to you separately once your exam is ready.
...
export const template = {
  component: BibleSchoolStudentNumberEmail,
  subject: (data: Record<string, any>) =>
    `Your ${data?.courseName || 'Bible School'} student number`,
  displayName: 'Bible School — student number',
  previewData: {
    firstName: 'Jane',
